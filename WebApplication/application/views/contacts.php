                ...
                <div class="row-col row-col-xs b-b">
                    ...
                    <div class="col-sm-2 col-md-2 w w-auto-sm b-r">
                        <div class="row-col">
                            ...
                            <div class="p-a">
                                <span bs-tooltip="" title="Double click to Edit"
                                      class="pull-right text-muted inline p-a-xs m-r-sm"><i class="fa fa-question"></i></span>
                                <a href="" class="btn btn-sm white"><i class="fa fa-plus fa-fw m-r-xs"></i> <span
                                            class="hidden-sm-down">New Group</span></a>
                            </div>
                        </div>
                    </div>
                    <!-- /column -->
                    ...
                    <span class="w-40 avatar">
                      <img src="<?php echo base_url() ?>assets/images/a0.jpg" class="img-circle">
                                                ...
                                                <div class="list-body">
                                                    Bertina Robert
                                                    <small class="block"><i class="fa fa-phone m-r-sm text-muted"></i>(021)
                                                        1234 8755
                                                    </small>
                                                </div>
                                            </div>
                    ...
                    <span class="w-40 avatar">
                      <img src="<?php echo base_url() ?>assets/images/a5.jpg" class="img-circle">
                                            ...
                                            <div class="list-item pointer">
                                                <div class="list-left">
                    <span class="w-40 avatar">
                      <img src="<?php echo base_url() ?>assets/images/a6.jpg" class="img-circle">
                    </span>
                                                </div>
                                                <div class="list-body">
                                                    Deborah
                                                    <small class="block"><i class="fa fa-phone m-r-sm text-muted"></i>332
                                                        233 2332
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="list-item pointer">
                                                <div class="list-left">
                    <span class="w-40 avatar">
                      <img src="<?php echo base_url() ?>assets/images/a7.jpg" class="img-circle">
                    </span>
                                                </div>
                                                <div class="list-body">
                                                    Emily
                            ...
                            <div class="p-a b-t text-center">
                                <a href="" class="btn btn-sm white btn-addon"><i class="fa fa-plus fa-fw m-r-xs"></i>
                                    New Contact</a>
                            </div>
                        </div>
                    </div>
